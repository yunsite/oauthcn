...
class WEIBOOAuth {
    ...
    public $host = 'https://api.weibo.com/2/'; //地址前端
	
    public static $boundary = ''; //静态 多块的边界
    public static $Referer = 'api.t.sina.com.cn'; //来源
...
function __construct($app_key, $app_secret) {
    ...
    function access_tokenURL() { return 'https://api.weibo.com/oauth2/access_token'; }
...
function get_authorizeURL($uri, $type, $wicket = NULL, $state = NULL) {
 ...
 switch($wicket){
    ...
    case '2':
        ...
        break;
    case '3':
        $params['display'] = 'wap1.2'; //移动终端1.2
    break;
    case '4':
        $params['display'] = 'wap2.0'; //移动终端2.0
    break;
    case '5':
