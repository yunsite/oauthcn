...
class TQQOAuth {
    ...
    public $host = 'http://open.t.qq.com/api/'; //地址前端
    ...
    public static $Referer = 't.qq.com'; //来源
...
function __construct($client_id, $client_secret) {
    ...
    // 授权地址
    function request_tokenURL() { return 'https://open.t.qq.com/cgi-bin/request_token'; }
    function authorizeURL() { return 'https://open.t.qq.com/cgi-bin/authorize'; }
    function access_tokenURL() { return 'https://open.t.qq.com/cgi-bin/access_token'; }
