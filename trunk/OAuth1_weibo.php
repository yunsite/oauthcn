...
class WEIBOOAuth {
    ...
    public $host = 'http://api.t.sina.com.cn/'; //地址前端
...
function __construct($client_id, $client_secret) {
    ...
    // 授权地址
    function request_tokenURL() { return 'http://api.t.sina.com.cn/oauth/request_token'; }
    function authorizeURL() { return 'http://api.t.sina.com.cn/oauth/authorize'; }
    function access_tokenURL() { return 'http://api.t.sina.com.cn/oauth/access_token'; }
